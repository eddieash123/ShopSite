...
export class CartComponent implements OnInit{
  ...
  //   this.formData.products = this.cartItems.map(item => ({
  //     name: item.name,
  //     price: item.price
  //   }));
  // }
  ...
  submitForm() {
    // Navigate to another component and pass formData as state
    this.router.navigate(['/order-details'], { state: { formData: this.formData } });
  }
